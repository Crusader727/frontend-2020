...
Для диплоя на github pages вам необходимо будет собрать продовую сборку npm run build, и файлик который вам соберется залить на Pages.
